...
class TimelineViewController: NSViewController, GestureResponder, SelectionHandler, NSCollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        TouchManager.instance.timelineGestureManager = gestureManager
    ...
    func reset(animated: Bool) {
        set(date: RecordDate(day: Constants.initialDate.day, month: Constants.initialDate.month, year: Constants.initialDate.year), animated: animated)
    ...
    private func didPanTimelineBase(_ gesture: GestureRecognizer) {
        ...
        case .recognized, .momentum:
            ...
            set(verticalPosition: offset, animated: false)
        default:
            return
        }
    }
